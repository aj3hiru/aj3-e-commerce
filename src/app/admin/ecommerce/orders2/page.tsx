...
/**
 * /admin/ecommerce/orders2 — a redesign of All Orders, kept alongside
 * /admin/ecommerce/orders. Same access rule, no database change.
 *
 * All five sidebar entries are this one page:
 *   All Orders        → /admin/ecommerce/orders2
 *   Pending Orders    → /admin/ecommerce/orders2?type=Pending
 *   Progress Orders   → /admin/ecommerce/orders2?type=In+Progress
 *   Delivered Orders  → /admin/ecommerce/orders2?type=Delivered
 *   Canceled Orders   → /admin/ecommerce/orders2?type=Canceled
