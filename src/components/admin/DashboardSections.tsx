...
// PHP number_format() grouping — see lib/format.ts for why this is not en-IN.
const fmt = formatInt;
  ...
  return (
    <>
      <div className={cn(!isVisible("online") && "hidden")}>
        <div className="mb-3 mt-6 flex items-center gap-2 text-[0.75rem] font-bold uppercase tracking-[0.05em] text-admin-gray-400">
          <Globe className="h-3.5 w-3.5" /> Online Platform
        </div>
        <div className="grid grid-cols-1 gap-x-6 gap-y-4 bs-sm:grid-cols-2 bs-lg:grid-cols-4">
      ...
      <div className={cn(!isVisible("earnings") && "hidden")}>
        <div className="mb-3 mt-6 flex items-center gap-2 text-[0.75rem] font-bold uppercase tracking-[0.05em] text-admin-gray-400">
          <HandCoins className="h-3.5 w-3.5" /> Earnings &amp; Due ({rangeLabel})
        </div>
        <div className="grid grid-cols-1 gap-x-6 gap-y-4 bs-sm:grid-cols-2 bs-lg:grid-cols-4">
        ...
        <div className="mb-3 mt-6 text-[0.75rem] font-bold uppercase tracking-[0.05em] text-admin-gray-400">
      ...
      <div className={cn(!isVisible("overview") && "hidden")}>
        <div className="mb-3 mt-6 text-[0.75rem] font-bold uppercase tracking-[0.05em] text-admin-gray-400">Store Overview</div>
        <div className="grid grid-cols-1 gap-x-6 gap-y-4 bs-sm:grid-cols-2 bs-lg:grid-cols-4">
