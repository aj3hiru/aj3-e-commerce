...
export const CUSTOMERS2_GROUPS: readonly WidgetGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "cus2-c-photo", label: "Profile photo" },
      { key: "cus2-c-joined", label: "Joined / last order line" },
      ...
      { key: "cus2-c-login", label: "Login (OTP / password)" },
      { key: "cus2-c-addresses", label: "Saved addresses" },
